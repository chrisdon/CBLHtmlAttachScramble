...
public class MyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            SevenCityApplication.createStructuralViews(DBNAME);
            if(SevenCityApplication.getDatabase(DBNAME) != null) renderWebView();
